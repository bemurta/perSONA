...
/*
	...
	unterbunden. Sollte dies zu Performance-Problemen führen, kann ein
	verfeinerter Locking-Mechanismus entwickelt werden. Zunächst mal aber so.


	TODO: Überall sicherstellen, das ITAExceptions zu VAExceptions umgebaut werden!!!
...
/*
	...
	Problem: Intern können auch andere Typen von Ausnahmen als
	CVAException geworfen werden. Nach aussen hin dürfen
	aber NUR CVAExceptions geworfen werden (Konsistent)

	Lösung: TRY-/CATCH-Makros für abgesicherte Bereiche in allen Methoden
	der externen Schnittstelle. Zweistufiger Aufbau.
	1. (innen) Fange alle Exception-Typen und konvertiere sie in CVAExceptions
	2. (aussen) Fange die einzig mögl. CVAExceptions und biete
	gemeinsamen Catch-Weg zur Problemlösung (Aufräumen) an
...
private:
	...
	ITAStreamProbe* m_pStreamProbeDeviceOutput;
