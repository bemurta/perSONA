set( VANETCSWRAPPER_VERSION_TYPE    "" )
set( VANETCSWRAPPER_VERSION_NAME    "" )
set( VANETCSWRAPPER_VERSION_MAJOR     )
set( VANETCSWRAPPER_VERSION_MINOR     )
set( VANETCSWRAPPER_VERSION_PATCH     )
set( VANETCSWRAPPER_VERSION_TWEAK     )
set( VANETCSWRAPPER_VERSION_HWARCH  "win32-x64.vc12" )

set( VANETCSWRAPPER_VERSION         "" )
set( VANETCSWRAPPER_VERSION_EXT     "" )
...
if( "${PACKAGE_FIND_VERSION}" STREQUAL "" AND "${PACKAGE_FIND_VERSION_EXT}" STREQUAL "" )
	...
	if( NOT PACKAGE_FIND_VERSION_EXT )
		set( PACKAGE_VERSION "${VANETCSWRAPPER_VERSION}" )

		# the cmake native versioning system: just allows an exact match with MAJOR.MINOR.PATCH - just works for releases!
		if( VANETCSWRAPPER_VERSION_TYPE STREQUAL "RELEASE" )
			set( PACKAGE_VERSION_EXACT TRUE )
			set( PACKAGE_VERSION_COMPATIBLE TRUE )
			set( PACKAGE_VERSION_UNSUITABLE FALSE )

			if( NOT PACKAGE_FIND_VERSION_MAJOR VERSION_EQUAL VANETCSWRAPPER_VERSION_MAJOR )
				set( PACKAGE_VERSION_EXACT FALSE )
				set( PACKAGE_VERSION_COMPATIBLE FALSE )
			endif( NOT PACKAGE_FIND_VERSION_MAJOR VERSION_EQUAL VANETCSWRAPPER_VERSION_MAJOR )

			if( PACKAGE_FIND_VERSION_COUNT GREATER 1 )
				if( NOT PACKAGE_FIND_VERSION_MINOR VERSION_EQUAL VANETCSWRAPPER_VERSION_MINOR )
					set( PACKAGE_VERSION_EXACT FALSE )
					set( PACKAGE_VERSION_COMPATIBLE FALSE )
				endif( NOT PACKAGE_FIND_VERSION_MINOR VERSION_EQUAL VANETCSWRAPPER_VERSION_MINOR )
			endif( PACKAGE_FIND_VERSION_COUNT GREATER 1 )

			if( PACKAGE_FIND_VERSION_COUNT GREATER 2 )
				if( NOT PACKAGE_FIND_VERSION_PATCH VERSION_EQUAL VANETCSWRAPPER_VERSION_PATCH )
					set( PACKAGE_VERSION_EXACT FALSE )
					if( NOT PACKAGE_FIND_VERSION_PATCH VERSION_LESS VANETCSWRAPPER_VERSION_PATCH )
						set( PACKAGE_VERSION_COMPATIBLE FALSE )
					endif( NOT PACKAGE_FIND_VERSION_PATCH VERSION_LESS VANETCSWRAPPER_VERSION_PATCH )
				endif( NOT PACKAGE_FIND_VERSION_PATCH VERSION_EQUAL VANETCSWRAPPER_VERSION_PATCH )
			endif( PACKAGE_FIND_VERSION_COUNT GREATER 2 )

			if( PACKAGE_FIND_VERSION_COUNT GREATER 3 )
				if( NOT PACKAGE_FIND_VERSION_TWEAK VERSION_EQUAL VANETCSWRAPPER_VERSION_TWEAK )
					set( PACKAGE_VERSION_EXACT FALSE )
					if( NOT PACKAGE_FIND_VERSION_TWEAK VERSION_LESS VANETCSWRAPPER_VERSION_TWEAK )
						set( PACKAGE_VERSION_COMPATIBLE FALSE )
					endif( NOT PACKAGE_FIND_VERSION_TWEAK VERSION_LESS VANETCSWRAPPER_VERSION_TWEAK )
				endif( NOT PACKAGE_FIND_VERSION_TWEAK VERSION_EQUAL VANETCSWRAPPER_VERSION_TWEAK )
			endif( PACKAGE_FIND_VERSION_COUNT GREATER 3 )

		else( VANETCSWRAPPER_VERSION_TYPE STREQUAL "RELEASE" )

			set( PACKAGE_VERSION_EXACT FALSE )
			set( PACKAGE_VERSION_COMPATIBLE FALSE )
			set( PACKAGE_VERSION_UNSUITABLE TRUE )

		endif( VANETCSWRAPPER_VERSION_TYPE STREQUAL "RELEASE" )

	else( NOT PACKAGE_FIND_VERSION_EXT )
		set( PACKAGE_VERSION "${VANETCSWRAPPER_VERSION_EXT}" )
		...
		if( NOT _IN_TYPE OR _IN_TYPE STREQUAL VANETCSWRAPPER_VERSION_TYPE )
			# in case of releases, we don't need a name
			if( NOT _IN_NAME AND VANETCSWRAPPER_VERSION_TYPE STREQUAL "RELEASE" )
				set( _IN_NAME ${VANETCSWRAPPER_VERSION_NAME} )
			endif( NOT _IN_NAME AND VANETCSWRAPPER_VERSION_TYPE STREQUAL "RELEASE" )
			...
			#check name
			if( NOT _IN_NAME STREQUAL VANETCSWRAPPER_VERSION_NAME )
				set( PACKAGE_VERSION_EXACT FALSE )
				set( PACKAGE_VERSION_COMPATIBLE FALSE )
			else( NOT _IN_NAME STREQUAL VANETCSWRAPPER_VERSION_NAME )
				#check versions - these automatically adjust PACKAGE_VERSION_EXACT and PACKAGE_VERSION_COMPATIBLE
				_local_check_valid_subversion( "${_IN_MAJOR}" "${VANETCSWRAPPER_VERSION_MAJOR}" FALSE )
				_local_check_valid_subversion( "${_IN_MINOR}" "${VANETCSWRAPPER_VERSION_MINOR}" FALSE )
				_local_check_valid_subversion( "${_IN_PATCH}" "${VANETCSWRAPPER_VERSION_PATCH}" TRUE )
				_local_check_valid_subversion( "${_IN_TWEAK}" "${VANETCSWRAPPER_VERSION_TWEAK}" TRUE )
			endif( NOT _IN_NAME STREQUAL VANETCSWRAPPER_VERSION_NAME )

		else( NOT _IN_TYPE OR _IN_TYPE STREQUAL VANETCSWRAPPER_VERSION_TYPE )
			set( PACKAGE_VERSION_EXACT FALSE )
			set( PACKAGE_VERSION_COMPATIBLE FALSE )
		endif( NOT _IN_TYPE OR _IN_TYPE STREQUAL VANETCSWRAPPER_VERSION_TYPE )
...
if( VISTA_HWARCH AND NOT "${VISTA_HWARCH}" STREQUAL "${VANETCSWRAPPER_VERSION_HWARCH}" )
	set( PACKAGE_VERSION_EXACT FALSE )
	set( PACKAGE_VERSION_COMPATIBLE FALSE )
	set( PACKAGE_VERSION_UNSUITABLE TRUE )
endif( VISTA_HWARCH AND NOT "${VISTA_HWARCH}" STREQUAL "${VANETCSWRAPPER_VERSION_HWARCH}" )
